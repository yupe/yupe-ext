...
class IPValidator extends CValidator
{
    ...
    public $v4pattern = '/^(([1-9]?[0-9]|1[0-9]{2}|2[0-4][0-9]|25[0-5])\.){3}([1-9]?[0-9]|1[0-9]{2}|2[0-4][0-9]|25[0-5])(\/\d*)?$/';
    ...
    protected function validateAttribute($object, $attribute)
    {
        ...
        $valid = (strtolower($this->version) === 'v6') ? preg_match($this->v6pattern, $value) : preg_match(
            $this->v4pattern,
            $value
        );
        ...
        if (!$valid) {
            $message = $this->message !== null ? $this->message : Yii::t(
                'yii',
                '{attribute} is not a valid IP' . $this->version . ' address.'
            );
